...
\comment{In the current work, we employ a tensorized Gaussian quadrature to construct the PC surrogate
model. To this end, 125 \geoclaw simulations were needed to compute the PC coefficients using Equation~\ref{eq:nisp}.
