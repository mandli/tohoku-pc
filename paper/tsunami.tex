...
accurate bathymetry for the region \cite{Amante:2009ud}.  \comment{Needs rewording: While it is the case
...
not included in this study due to the availability of the data and the
insensitivity of the simulation to the finer bathymetry at the DART buoy
locations.} The bathymetry and topography of the considered regions are 
shown in Figure~\ref{fig:setup_buoy_locations}.

\comment{Needs discussing in results section as well: Two earthquake source models were run to test whether the friction UQ analysis
