...
in particular the Manning's $n$ friction coefficient. Our objective here is to 
present an efficient method for the 
...
\geoclaw model and then employs the Bayesian inference to estimate the three uncertain parameters
using the DART buoys data obtained during \tohoku tsunami. The efficiency of our approach stems from 
