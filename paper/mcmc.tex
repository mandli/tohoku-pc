...
\comment{The plots show a good agreement between the simulations and the 
...
appears to be well mixed with a well defined posterior range between 0.02 and 0.022.\comment{discussion}.
