...
but these previous studies \comment{were limited in the scope of the changes to the parameterization allowed}.  
...
response of the large and complex geophysical model simulations \comment{ref on pcs}.
