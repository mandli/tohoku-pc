...
\comment{Previous work looking into uncertainty in the input of tsunami models
focused on the earthquake source models but primarily as a way of
constraining the various proposed earthquake scenarios} (see
...
\comment{values and locations used in the parameterization}.  
...
including the \comment{source models analyzed there}.
