...
that has proven extremely useful in solving UQ problems~\cite{Xiu:2003,Lin2009}. The existence and convergence of this series is asserted by the Cameron-Martin theorem \citep{Cameron:1947} with the condition of $U$ having a finite variance.
...
PC representations of random variables also enable conducting
efficient global sensitivity analysis that aims to quantify the
contribution of different random input parameters to the model variability.
