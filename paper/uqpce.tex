...
once for every proposed set of parameters of the Markov chain \comment{add reference}. While a single \geoclaw simulation
...
tensor products of 1D basis functions \comment{add refer}.
...
that has proven extremely useful in solving UQ problems\comment{add refer}. The existence and convergence of this series is asserted by the Cameron-Martin theorem \citep{Cameron:1947} with the condition of $U$ having a finite variance.
...
approximation of the corresponding variance-based, \comment{global
