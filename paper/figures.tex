...
\end{subfigure}
\caption{Figure~\ref{fig:setup_buoy_locations} shows the topography, bathymetry and gauge locations used in the simulation.  Figure~\ref{fig:setup_buoy_data} shows observed de-tided water surface height at all the DART buoys used.}
\label{fig:setup}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure}[ht]      
