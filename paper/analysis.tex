...
during the tsunami event.  \comment{Why is this?}
...
This is achieved by sampling the PC surrogate for different values of the term $\xxi$ within the prior
...
\comment{Do you mean ``Since $n_1$ shows insignificant contribution...'' rather than $n_3$?  The value picked for $n_1$ also is quite high, can we pick something more reasonable such as 0.035?}
