...
during the tsunami event.  \comment{The narrowing of the variance at these instances
is possibility due to the waves that are arriving
during these times and reflected from a single source or from a region
where the Manning's $n$ values have little influence over these waves (as
opposed to those being reflected off the Japanese coast).}
